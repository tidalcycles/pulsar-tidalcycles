...
export default class REPL {
  ...
  constructor(consoleView, ghc, bootTidal, status) {
  ...
  flushStdOut() {
    if (this.stdOut.length) {
      ...
      output = this.consoleView.prompt() + output
  ...
  toggleMute(connection) {
    ...
    this.consoleView.logMutes(this.mutes, connectionRef)
  }
  ...
  toggleMuteAll() {
    ...
    this.consoleView.logMutes(this.mutes, 'all')
  }
