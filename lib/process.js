...
export default class Process extends EventEmitter {
  ...
  static ghci(path) {
    const command = "(cd /Users/mrreason/Development/tidalcycles/MrReason ; stack exec --package MrReason ghci)";
    return new Process(child_process.spawn(command, [], { shell: true }))
  }
