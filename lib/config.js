...
export default {
  ...
  'oscServer': {
    type: 'object',
    title: 'OSC Server',
    description: 'Configuration for the OSC server',
    properties: {
      'ip': {
        type: 'string',
        default: '127.0.0.1',
        title: 'ip',
        description: `OSC Server ip address for receiving messages.`,
        order: 71
      },
      'port': {
        type: 'integer',
        default: 3333,
        title: 'port',
        description: `OSC Server port for receiving messages.`,
        order: 72
      }
    }
  },
