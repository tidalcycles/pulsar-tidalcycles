...
export default {
    ...
    activate() {
      ...
      if (atom.config.get('tidalcycles.interpreter') === 'listener') {
        ...
        this.ghc.init();
        this.eventHighlighter = new EventHighlighter(this.consoleView);
      ...
      if (atom.config.get('tidalcycles.oscEval.enable')) {
        this.oscLoader = new OscLoader(this.consoleView, this.eventHighlighter, this.repl, this.editors);
        this.oscLoader.init();
      }
