...
//const stackPrefix = 'stack exec --package tidal MrReason'
const stackPrefix = '(cd /Users/mrreason/Development/tidalcycles/MrReason ; stack exec --package MrReason ghci)'
...
export default class Ghc {
  ...
  init() {
    console.log("Interpreter Property", atom.config.get(interpreterProperty));
