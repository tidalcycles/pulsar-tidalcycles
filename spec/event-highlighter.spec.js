...
import EventHighlighter from '../lib/event-highlighter';
...
const eventHighlighter = new EventHighlighter();
...
describe('Event Map Helper', () => {
  ...
  describe('diffEventMaps', () => {
      ...
      it('should return the correct differences for deleted events', () => {
        const {removed} = eventHighlighter.diffEventMaps(messageBuffer,receivedMessagesThisFrame);
      ...
      it('should return the correct differences for added events', () => {
        const {added} = eventHighlighter.diffEventMaps(messageBuffer,receivedMessagesThisFrame);
      ...
      it('should return the correct differences for active events', () => {
        const {active} = eventHighlighter.diffEventMaps(messageBuffer,receivedMessagesThisFrame);
  ...
  describe('transformedEvents', () => {
      it('should return the transformed Sets into correspondings Maps', () => {
        ...
        const transformedEvents = eventHighlighter.transformedEvents(events);
